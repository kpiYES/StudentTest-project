...
public class CreateTestTestsFragmentCommand implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if ("finishCreatingTest".equals(request.getParameter("action"))) {
            Set<Long> chosenQuestionsIdSet = (Set<Long>) request.getSession().getAttribute("chosenQuestionsSet");
            ...
            testService.create(chosenQuestionsIdSet, subject, testName);
