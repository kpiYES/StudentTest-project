...
<div class="user_form">
    <form method="post" action="dispatcher">
        <p> FirstName: <input type="text" name="firstName" size="30" value="${sessionScope.userDTO.firstName}"
                              readonly/></p>
        <p> LastName: <input type="text" name="lastName" size="30" value="${sessionScope.userDTO.lastName}" readonly/>
        </p>
